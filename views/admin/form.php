    ...
    <div class="row">
        <div class=" col-md-6">
            <div class="form-group">
                ...
                <?php echo form_input('org_path',$asignacion->org_path,'class="form-control" disabled')?>
            ...
            <div class="form-group">
                <label>Nombre</label>
                <?php if ($this->method!='asignar'):?>
                <?php echo form_input('full_name',$asignacion->full_name,'class="form-control" disabled')?>
                <?php elseif ($this->method=='asignar'):?>
            ...
            <div class="form-group">
                <label>Email</label>
                <?php echo form_input('email',$asignacion->email,'class="form-control" ng-model="email_alum" required ng-init="email_alum=\''.$asignacion->email.'\'"'.($this->method!='asignar'?'disabled':''));?>
            </div>
        ...
        <div class="col-lg-6">   
            <div class="form-group">
                <label>Serial</label>
                <?php echo form_input('id_chromebook',$asignacion->id_chromebook,'class="form-control" disabled')?>
            </div>
                <div class="form-group">
                <label>Responsable</label>
                <?php echo form_input('responsable',$asignacion->responsable,'class="form-control" required '.($this->method!='asignar'?'disabled':''));?>
            </div>
        <div class="form-group" >
